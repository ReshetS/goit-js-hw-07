...
function createBoxes(amount) {
  ...
  /* Якби нам потрібно було добавляти бокси до існуючих, логіка була б інша,
  а так як нам потрібно очистити бокси і прописати нові, то використовуємо
  банальний innerHTML, щоб браузер двічі не рендерив сторінку */
}
